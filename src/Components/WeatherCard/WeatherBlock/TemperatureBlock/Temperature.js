        ...
        <div className='temperature-block'>
            ...
            <div className='temperature-settings'>
                {   unit==='C' 
                    ...
                    : <div className='unit unactive' onClick={convertToCels}>°C</div>
                }
                <div className='line'></div>

                {
                    unit==='F'
                    ? <div className='unit active' onClick={convertToFahr}>°F</div>
                    : <div className='unit unactive' onClick={convertToFahr}>°F</div>
                }                  
            </div>
